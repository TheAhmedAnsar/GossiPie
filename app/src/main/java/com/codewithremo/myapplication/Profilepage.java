...
//
//class ProfilePage extends AppCompatActivity {
//    CardView cardView;
//    ImageView imageView;
//    int PICK_Image=123;
//    Uri imagepath;
...
//                if (name.isEmpty()) {
//                    Toast.makeText(ProfilePage.this, "Enter your username", Toast.LENGTH_SHORT).show();
//                } else {
//
//                    senddatafornewuser();
...
//
//                Toast.makeText(ProfilePage.this, "UID added Succesfully", Toast.LENGTH_SHORT).show();
//                senddataToCloudSFiretore();
//            }
//        }).addOnFailureListener(new OnFailureListener() {
//            @Override
//            public void onFailure( @NotNull Exception e) {
//                Toast.makeText(ProfilePage.this, "Uri Failed to add", Toast.LENGTH_SHORT).show();
//
//
//            }
//        });
